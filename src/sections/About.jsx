      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1 md:col-span-4">
          ...
          <div className="z-10">
            ...
            <p className="subtext">
              ...
              backend dev skill to deliver dynamic and responsive
              software and web applications.
            </p>
          </div>
           <div className="absolute inset-x-0 pointer-events-evets-none-bottom-4
        ...
        <div className="grid-black-color grid-3 md:col-span-2">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext ">I'm based in Mars, and open to remote work world
              worldwide
            </p>
        ...
        <div className="grid-default-color grid-5 md:col-span-2">
          ...
          <p className="subtext"> I specialize in a varity oflanguages, frameworks,
            and tools that
            allow me to build robust and scalable applications
          </p>
